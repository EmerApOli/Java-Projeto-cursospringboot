...
public class ControleExcecoes extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
		...
		return new ResponseEntity<ObjetoError>(objetoError, headers, status);
	}*/
	...
	@ExceptionHandler({ DataIntegrityViolationException.class, ConstraintViolationException.class, PSQLException.class,
			SQLException.class })
	protected ResponseEntity<ObjetoError> handleExceptionDataIntegry(Exception ex) {
		...
		return new ResponseEntity<ObjetoError>(objetoError, HttpStatus.INTERNAL_SERVER_ERROR);
	}
